...
export default function Cart() {
  ...
  if (data?.numOfCartItems == 0 || data == null)
    return (
      <div className="pt-5 mt-4 text-center">
        <h2 className=" text-main mt-5 pt-5">
          <b>Your cart is empty</b>
        </h2>
        <button className="btn mt-2 p-3 bg-info mb-5">
          {" "}
          <Link to={"/home"}>
            {" "}
            <b> Go shopping</b>{" "}
  ...
  return (
    <>
      ...
      <div className="container my-5 bg-main-light pt-3 rounded-1">
        <h3 className="mt-4 py-2">
          <b>Your shopping cart :</b>
        </h3>
        <h5 className="text-main">
          <b>Total price:</b> {data?.data.totalCartPrice} EGP
        </h5>
            ...
            <div className="row border-bottom" key={item._id}>
              ...
              <div className="col-md-10 mt-3 d-flex justify-content-between">
                <div>
                  ...
                  <button
                    className="btn text-white mb-2 text-bg-danger"
                ...
                <div>
                  ...
                  <button
                    className=" btn brdr"
                    onClick={() => update(item.product._id, item.count + 1)}
                  >
                    +
                  </button>
                </div>
        ...
        <Link
          className="bg-main text-white btn my-3 mx-5"
